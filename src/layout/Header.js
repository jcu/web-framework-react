...
export default class Header extends Component {
  ...
  render () {
    ...
    switch (logo) {
      ...
      case 'mono-reversed':
        logo =
          'https://cdn.jcu.edu.au/1.0.0-beta.1/images/jcua-logo-mono-reversed.svg'
        break
      case 'colour':
                ...
                <div className='col-xs-6'>
                  <a href={url}>
                    <img
                      className='img-fluid'
                      src={logo}
                      alt='JCU Australia logo'
                    />
                  </a>
                </div>
                {this.props.appName && (
                  <div className='col-xs-6 text-sm-right'>
                    <h1 className='jcu-header__page-title' id='page-title'>
                      <span className='sr-only'>James Cook University </span>
                      {this.props.appName}
                    </h1>
                  </div>
                )}
